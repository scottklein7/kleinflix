        ...
        <>
            <div className='navContainer'>
                <div className='navItems'>
                    ...
                    {props.user ?
                        <>
                            <img src={props.user.photoURL} alt={props.user.displayName} className='userImage' />
                            <button className='loginOutBtn' onClick={logout}>Logout</button>
                        </> :
                        <button className='loginOutBtn' onClick={login}>Login</button>
                    }
